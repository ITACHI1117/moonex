...
function Hero() {
  return (
    ...
    <div className="w-96 h-52 -left-20 -top-56 bg-buttonSecondGradient absolute rounded-full blur-3xl opacity-20"></div>
    <div className="w-96 h-52 -right-10 top-52 bg-buttonSecondGradient absolute rounded-full blur-3xl opacity-20"></div>
